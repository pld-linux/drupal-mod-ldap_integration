...
Ten moduł pozwala użytkownikom uwierzytelniać się względem katalogu
LDAP. Ponadto użytkownicy mogą czytać i modyfikować swoje dane w
katalogu LDAP, przy czym administrator może to prawo ograniczyć.
